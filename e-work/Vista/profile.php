                              ...
                              <!-- codigo ver informacion del usuario -->
                              <?php
                              require("../Controlador/conexion.php");

                                 $vista ="SELECT * FROM userData where id = 6";
                                 $result =mysqli_query($conex, $vista);
               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="landing.html"><img class="logo_icon img-responsive" src="images/logo/logo_icon.png" alt="#" /></a>
                     </div>
                  </div>
                  <div class="sidebar_user_info">
                     <div class="icon_setting"></div>
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="./img_user/IMG-20191129-WA0077.jpg" alt="#" /></div>
                        <div class="user_info">
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="img_user/IMG-20191129-WA0077.jpg" alt="#" /><span class="name_user"><?php echo $row['userName'] ?></span></a>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          <div class="profile_img"><img width="180" class="rounded-circle" src="./img_user/IMG-20191129-WA0077.jpg" alt="#" /></div>
                                          <div class="profile_contant">
                                             <div class="contact_inner">
                                                <h3><?php echo $row['userName']?></h3>
                                                <h3><?php echo $row['userlastname']?></h3>
                                                <p><strong>Edad: <?php
                                                include "../Modelo/edad_user.php";
                                                $fechaini = $row['age'];
                                                $fechafin = date('Y-m-d');
                                                echo calcularTiempo($fechaini,$fechafin)[0];
                                                ?> </strong></p>
                                                <ul class="list-unstyled">
                                                   <li><i class="fa fa-envelope-o"></i> : <?php  echo $row['mail'] ?></li>
                                                   <li><i class="fa fa-phone"></i> : <?php echo $row['phone'] ?></li>
                                                   <li><i></i><strong>País: </strong> <?php echo $row['country'] ?></li>
                                                   <li><i></i> <strong>Ciudad: </strong>  <?php echo $row['city'] ?></li>
                                                   <li><i></i> <strong>Dirección: </strong>  <?php echo $row['userAddress'] ?></li>
                                                </ul>

                                             </div>
                                             <div class="user_progress_bar">
                                                <div class="progress_bar">
                                                   <a class="btn btn-primary xs"><strong>Editar:</strong></a>
                                                   <a class="btn btn-primary"><strong>Eliminar:</strong></a>
